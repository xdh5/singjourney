...
EXERCISES = [
    ...
    ("natural-mnn-third-hum", "natural", "Mnn三度哼鸣", "Mnn Third Hum", "用闭口Mnn从低音平稳上行到三度再回到低音，保持鼻腔共鸣和音高连贯。", "Hum Mnn from the lower note up to the third and back, keeping nasal resonance and pitch connected.", "1–2–3–2–1", "Mnn", 68, 4, "light", False),
    ("natural-mnn-third-hum-round-trip", "natural", "Mnn三度往返哼鸣", "Mnn Third Hum Round Trip", "用闭口Mnn逐级上行到舒适高音后再逐级回到低音，保持上下行的共鸣与音高一致。", "Hum Mnn upward by steps to a comfortable high note, then return step by step with consistent resonance and pitch.", "1–2–3–2–1（上行后回行）", "Mnn", 68, 1, "light", False),
