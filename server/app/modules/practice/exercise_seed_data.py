...
EXERCISES = [
    ...
    ("natural-mnn-third-hum", "natural", "三度哼唱", "Third Hum", "用闭口Mnn逐级上行到选定高音，再逐级回到选定低音，保持上下行的共鸣与音高一致。", "Hum Mnn upward to the selected high note, then return to the selected low note with consistent resonance and pitch.", "1–2–3–2–1（上行后回行）", "Mnn", 68, 1, "light", False),
